...
import { ACCOUNT_DISCRIMINATOR_SIZE, accountDiscriminator, accountSize, } from "../../coder";
    ...
    static build(idl, coder, programId, provider) {
        ...
        idl.accounts.forEach((idlAccount) => {
            ...
            const accountsNamespace = async (address) => {
                const accountInfo = await provider.connection.getAccountInfo(translateAddress(address));
                if (accountInfo === null) {
