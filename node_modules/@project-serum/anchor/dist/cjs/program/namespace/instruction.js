...
class InstructionNamespaceFactory {
    ...
    static build(idlIx, coder, programId) {
        ...
        const ix = (...args) => {
            ...
            const keys = InstructionNamespaceFactory.accountsArray(ctx.accounts, idlIx.accounts);
            ...
            return new web3_js_1.TransactionInstruction({
                keys,
                programId,
                data: coder.instruction.encode(idlIx.name, common_1.toInstruction(idlIx, ...ixArgs)),
            });
        };
