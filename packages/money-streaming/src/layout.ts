 ...
 */
export const addFundsLayoutV0: typeof BufferLayout.Structure = BufferLayout.struct([
  BufferLayout.u8('tag'),
 ...
 */
export const withdrawLayoutV0: typeof BufferLayout.Structure = BufferLayout.struct([
  BufferLayout.u8('tag'),
 ...
 */
export const pauseOrResumeLayout: typeof BufferLayout.Structure = BufferLayout.struct([BufferLayout.u8('tag')]);
 ...
 * Treasury layout
 */
export const treasuryV0Layout: typeof BufferLayout.Structure = BufferLayout.struct([
  BufferLayout.u8('initialized'),
 ...
 */
export const closeTreasuryLayout: typeof BufferLayout.Structure = BufferLayout.struct([BufferLayout.u8('tag')]);

/**
 * Refresh Treasury balance instruction layout
 */
export const refreshTreasuryBalanceLayout: typeof BufferLayout.Structure = BufferLayout.struct([
  BufferLayout.u8('tag'),
]);
